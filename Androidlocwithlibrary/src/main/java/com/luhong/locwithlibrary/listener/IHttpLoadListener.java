 ...
 * app版本更新接口
 */
public interface IHttpLoadListener extends Serializable {
    /**
     * 异步get
     *
     * @param url      get请求地址
     ...
     * @param callback 回调
     */
    void downloads(@NonNull String url, @NonNull String path, @NonNull String fileName, @NonNull FileCallback callback);
    ...
    interface FileCallback {
        ...
        /**
         * 请求之前
         * @param logoResId 通知栏小logo
         */
        void onBefore(int logoResId);
    }
