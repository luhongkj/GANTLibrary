package com.luhong.locwithlibrary.imagepicker;

import android.app.Activity;
import android.content.Intent;

import com.luhong.locwithlibrary.imagepicker.activity.ImagePickerActivity;
import com.luhong.locwithlibrary.imagepicker.manager.ConfigManager;
import com.luhong.locwithlibrary.imagepicker.utils.ImageLoader;
...
public class ImagePicker {
     ...
     * @return
     */
    public ImagePicker setIsFiltration(String path) {
        ConfigManager.getInstance().setSingPaths(path);
        return mImagePicker;
    }
