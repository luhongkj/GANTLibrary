package com.luhong.locwithlibrary.imagepicker.manager;
...
public class ConfigManager {
    ...
    private boolean showVideo = false;//是否显示视频，默认显示
    ...
    public void setSingPaths(String fileData) {
        this.fileData = fileData;
    }

    public String getSingPaths() {
        return fileData;
    }
